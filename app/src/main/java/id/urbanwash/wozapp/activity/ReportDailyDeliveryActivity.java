...
import id.urbanwash.wozapp.adapter.ReportDailyDeliveryAdapter;
...
public class ReportDailyDeliveryActivity extends BaseActivity implements ReportDailyListener {
    ...
    private ReportDailyDeliveryAdapter mReportDailyDeliveryAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleLabel.setText(getString(R.string.title_order_delivery));
        ...
        mReportDailyDeliveryAdapter = new ReportDailyDeliveryAdapter(mAppCompatActivity, this, mReports);
        mReportView.setAdapter(mReportDailyDeliveryAdapter);
    }
    ...
    public void onDateSelected(Date date) {
        ...
        Intent intent = new Intent(mAppCompatActivity, ReportHourlyDeliveryActivity.class);
    ...
    public void onAsyncGetReports(List<ReportBean> reports) {
        ...
        mReportDailyDeliveryAdapter.notifyDataSetChanged();
    ...
    public void getRecords() {
        ...
        if (Session.isTransporterUser()) {
            httpAsyncManager.getDailyDeliveryReport(Session.getEmployee());
        } else {
            httpAsyncManager.getDailyDeliveryReport();
        }
    }
}
