...
import id.urbanwash.wozapp.adapter.ReportMonthlyAdapter;
import id.urbanwash.wozapp.async.HttpAsyncManager;
import id.urbanwash.wozapp.listener.ReportMonthlyListener;
import id.urbanwash.wozapp.model.ReportBean;
import id.urbanwash.wozapp.util.CommonUtil;
import id.urbanwash.wozapp.widget.RecycleDividerItemDecoration;

public class ReportMonthlyActivity extends BaseActivity implements ReportMonthlyListener {
    ...
    private ReportMonthlyAdapter mReportMonthlyAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mYear = (Date) getIntent().getSerializableExtra(Constant.DATA_DATE);
        ...
        mTitleLabel.setText(CommonUtil.formatYear(mYear));
        ...
        mReportMonthlyAdapter = new ReportMonthlyAdapter(mAppCompatActivity, this, mReports);
        mReportView.setAdapter(mReportMonthlyAdapter);
    }
    ...
    @Override
    public void onMonthSelected(Date month) {

        Intent intent = new Intent(mAppCompatActivity, ReportDailyActivity.class);
        intent.putExtra(Constant.DATA_DATE, month);
    ...
    public void onAsyncGetReports(List<ReportBean> reports) {
        ...
        mReportMonthlyAdapter.notifyDataSetChanged();
    ...
    public void getRecords() {
        ...
        httpAsyncManager.getMonthlyReport(new Date());
    }
}
