...
public class ReportYearlyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private AppCompatActivity mAppCompatActivity;
    private ReportYearlyListener mReportMonthlyListener;

    private List<ReportBean> mReports;

    public ReportYearlyAdapter(AppCompatActivity appCompatActivity, ReportYearlyListener listener, List<ReportBean> reports) {
    ...
    private void setupReportViewHolder(ReportViewHolder holder, int position) {
        ...
        holder.dateLabel.setText(CommonUtil.formatYear(reportBean.getDate()));
    ...
    private View.OnClickListener getMainPanelOnClickListener(final ReportBean reportBean) {
        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mReportMonthlyListener.onYearSelected(reportBean.getDate());
            }
        };
    }
}
