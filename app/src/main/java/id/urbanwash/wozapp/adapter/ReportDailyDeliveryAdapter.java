...
public class ReportDailyDeliveryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ReportDailyDeliveryAdapter(AppCompatActivity appCompatActivity, ReportDailyListener listener, List<ReportBean> reports) {
