...
public class ReportMonthlyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private AppCompatActivity mAppCompatActivity;
    private ReportMonthlyListener mReportMonthlyListener;

    private List<ReportBean> mReports;

    public ReportMonthlyAdapter(AppCompatActivity appCompatActivity, ReportMonthlyListener listener, List<ReportBean> reports) {

        mAppCompatActivity = appCompatActivity;
        mReportMonthlyListener = listener;
    ...
    private void setupReportViewHolder(ReportViewHolder holder, int position) {
        ...
        holder.dateLabel.setText(CommonUtil.formatMonthYear(reportBean.getDate()));
    ...
    private View.OnClickListener getMainPanelOnClickListener(final ReportBean reportBean) {
        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mReportMonthlyListener.onMonthSelected(reportBean.getDate());
            }
        };
    }
}
