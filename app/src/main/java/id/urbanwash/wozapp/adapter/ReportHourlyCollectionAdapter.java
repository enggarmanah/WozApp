...
public class ReportHourlyCollectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private ReportDailyListener mReportDailyListener;

    private List<ReportBean> mReports;

    public ReportHourlyCollectionAdapter(ReportDailyListener listener, List<ReportBean> reports) {
    ...
    public static class ReportViewHolder extends RecyclerView.ViewHolder {
        ...
        private AppCompatTextView remarksLabel;
        ...
        ReportViewHolder(View view) {
            ...
            remarksLabel = (AppCompatTextView) view.findViewById(R.id.label_remarks);
    ...
    private void setupReportViewHolder(ReportViewHolder holder, int position) {
        ...
        holder.dateLabel.setText(CommonUtil.formatOperatingHrTimePeriod(reportBean.getDate()));
        holder.valueLabel.setText(CommonUtil.formatNumber(reportBean.getValue()));

        holder.remarksLabel.setVisibility(View.GONE);
    }
