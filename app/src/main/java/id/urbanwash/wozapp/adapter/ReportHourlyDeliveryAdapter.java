...
public class ReportHourlyDeliveryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private ReportDailyListener mReportDailyListener;

    private List<ReportBean> mReports;

    public ReportHourlyDeliveryAdapter(ReportDailyListener listener, List<ReportBean> reports) {
