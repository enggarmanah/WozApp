...
public class ReportDailyCollectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ReportDailyCollectionAdapter(AppCompatActivity appCompatActivity, ReportDailyListener listener, List<ReportBean> reports) {
    ...
    private void setupReportViewHolder(ReportViewHolder holder, int position) {
        ...
        holder.remarksLabel.setText(CommonUtil.formatDay(reportBean.getDate()));
